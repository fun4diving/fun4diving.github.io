...
<Layout title="首頁 Index :: Fun肆潛水-Fun 4 Diving Official">
  ...
  <div class="py-16 px-4 sm:px-6 max-w-7xl mx-auto space-y-24">
    ...
    <!-- 2. Google Maps 真實評價專區 (Google Reviews) -->
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
        ...
        <div class="bg-slate-900 rounded-2xl p-6 border border-slate-800 space-y-4 shadow-xl flex flex-col justify-between hover:border-cyan-500/40 transition">
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                <div class="w-9 h-9 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center font-bold text-white text-sm">
                  G
                </div>
                <div>
                  <p class="font-bold text-white text-sm">Google 在地嚮導</p>
                  <p class="text-xs text-slate-400">東北角 Fun Dive 體驗</p>
                </div>
              </div>
              <span class="text-xs text-amber-400 font-bold">★★★★★</span>
            </div>
            <p class="text-slate-200 text-sm leading-relaxed">
              「教練超級專業且超級注重水下安全！帶導潛非常細心，會仔細照顧每位潛友的狀況。潛點生態介紹豐富，下水過程輕鬆又安心，絕對是東北角 Fun Dive 第一首選！」
            </p>
          </div>
          <div class="pt-3 border-t border-slate-800/80 text-xs text-slate-400 flex items-center justify-between">
            ...
            <span class="text-cyan-400 font-medium">驗證顧客</span>
          </div>
        </div>
        ...
        <div class="bg-slate-900 rounded-2xl p-6 border border-slate-800 space-y-4 shadow-xl flex flex-col justify-between hover:border-cyan-500/40 transition">
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                <div class="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center font-bold text-white text-sm">
                  G
                </div>
                <div>
                  <p class="font-bold text-white text-sm">Google 潛友評論</p>
                  <p class="text-xs text-slate-400">背包客房與潛旅</p>
                </div>
              </div>
              <span class="text-xs text-amber-400 font-bold">★★★★★</span>
            </div>
            <p class="text-slate-200 text-sm leading-relaxed">
              「潛店基地位置非常好，背包客房乾淨整潔、設備完善！有專屬的大空間洗晾裝備區，週五下班先過來住一晚，隔天早起下水超級方便，氛圍溫馨得像回到家一樣！」
            </p>
          </div>
          <div class="pt-3 border-t border-slate-800/80 text-xs text-slate-400 flex items-center justify-between">
            <span>來自 Google Maps 評論</span>
        ...
        <div class="bg-slate-900 rounded-2xl p-6 border border-slate-800 space-y-4 shadow-xl flex flex-col justify-between hover:border-cyan-500/40 transition">
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                <div class="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center font-bold text-white text-sm">
                  G
                </div>
                <div>
                  <p class="font-bold text-white text-sm">Google 滿分好評</p>
                  <p class="text-xs text-slate-400">考照與體驗潛水</p>
                </div>
              </div>
              <span class="text-xs text-amber-400 font-bold">★★★★★</span>
            </div>
            <p class="text-slate-200 text-sm leading-relaxed">
              「教練教學有耐性又活潑，完全不會有壓迫感，把每個動作跟安全細節都教得很紮實！跟著 Fun 肆考完證照後還能跟著團上船潛，認識很多同好，大力推薦給想學潛水的朋友！」
            </p>
          </div>
          <div class="pt-3 border-t border-slate-800/80 text-xs text-slate-400 flex items-center justify-between">
            <span>來自 Google Maps 評論</span>
