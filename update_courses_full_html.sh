#!/bin/bash
set -e
echo "📦 正在將 Webnode 課程與住宿頁面 100% 內容寫入 src/pages/courses.astro..."
        ...
        <div class="bg-slate-900 rounded-2xl border border-slate-800 p-6 space-y-4 shadow-xl">
          ...
          <div class="space-y-3 divide-y divide-slate-800/60">
            ...
            <div class="flex justify-between items-center pt-2">
              ...
              <div class="text-lg font-mono font-bold text-cyan-300">13,000 NTD起</div>
            </div>
            ...
            <div class="flex justify-between items-center pt-3">
              ...
              <div class="text-lg font-mono font-bold text-cyan-300">12,000 NTD起</div>
            </div>
...
# 推送至 GitHub
echo "🚀 正在將課程與住宿 (Courses) 頁面完整推送至 GitHub..."
git add src/pages/courses.astro
git commit -m "Update Courses and Hostel page to 100% match raw Webnode HTML content" || true
