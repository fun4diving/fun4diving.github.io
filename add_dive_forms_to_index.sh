#!/bin/bash
set -e
echo "📝 正在更新 index.astro：加入 Fun Dive 岸潛與船潛報名表單至『我們的服務』之上..."
...
git commit -m "Add Fun Dive shore and boat diving signup forms to home page above services" || true
git push origin main

echo "✨ 更新完成！等待約 1 分鐘即可造訪首頁查看最新排版！"
