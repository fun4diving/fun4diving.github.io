...
# 推送至 GitHub
echo "🚀 正在將更新後的圖片漸層推送至 GitHub..."
git add src/pages/index.astro
git commit -m "Reduce image bottom gradient mask height to half in Index page" || true
git push origin main --force

echo "✨ 完成！照片透明度與視野已大幅提昇！"
