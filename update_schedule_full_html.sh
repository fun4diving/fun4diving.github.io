#!/bin/bash
set -e
echo "📦 正在將完整含國旗 Icon 的活動列表寫入 src/pages/schedule.astro..."
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div class="space-y-8">
        ...
        <div class="bg-slate-900/90 p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-xl space-y-6">
          ...
          <!-- 小琉球 -->
          <div class="space-y-2 pb-4 border-b border-slate-800/60">
            <h3 class="text-lg font-bold text-white">🇹🇼 小琉球潛水團</h3>
          ...
          <!-- 墾丁七星岩 -->
          <div class="space-y-2 pb-4 border-b border-slate-800/60">
            <h3 class="text-lg font-bold text-white">🇹🇼 七星岩</h3>
            <p class="text-slate-300 text-sm">👤 主辦：老王</p>
          ...
          <!-- 澎湖 -->
          <div class="space-y-2">
            <h3 class="text-lg font-bold text-white">🇹🇼 澎湖南方四島</h3>
            <p class="text-slate-300 text-sm">👤 主辦：老王</p>
        ...
        <div class="bg-slate-900/90 p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-xl space-y-6">
          ...
          <div class="space-y-3 pb-4 border-b border-slate-800/60">
            <h3 class="text-xl font-bold text-white">🇵🇭 菲律賓</h3>
            ...
            <p class="text-white font-semibold">🇵🇭 2026國慶媽媽島長尾鯊</p>
            <p class="text-slate-300 text-sm">👤 主辦：阿豪,吉米</p>
          ...
          <div class="space-y-4 pb-4 border-b border-slate-800/60">
            <h3 class="text-xl font-bold text-white">🇲🇾 馬來西亞</h3>
            <div class="space-y-2">
              <p class="text-white font-semibold">🇲🇾 西巴丹</p>
              <p class="text-slate-300 text-sm">👤 主辦：阿豪,吉米</p>
            ...
            <div class="space-y-2 pt-2">
              <p class="text-white font-semibold">🇲🇾 西巴丹(中秋假期）</p>
              <p class="text-slate-300 text-sm">👤 主辦：阿豪,吉米</p>
          ...
          <!-- 印尼 -->
          <div class="space-y-4 pb-4 border-b border-slate-800/60">
            <h3 class="text-xl font-bold text-white">🇮🇩 印尼</h3>
            <div class="space-y-1">
              <p class="text-white font-semibold">🇮🇩 科摩多</p>
              <p class="text-slate-300 text-sm">👤 主辦：阿豪,吉米</p>
              <p class="text-slate-300 text-sm">🗓️ 日期：2027/4/3-4/6</p>
              <p class="text-amber-400 text-sm">ℹ️ 活動資訊：籌備中</p>
            </div>
            <div class="space-y-1 pt-2">
              <p class="text-white font-semibold">🇮🇩 馬拉圖</p>
              <p class="text-slate-300 text-sm">👤 主辦：阿豪,吉米</p>
          ...
          <!-- 馬爾地夫 -->
          <div class="space-y-2 pb-4 border-b border-slate-800/60">
            <h3 class="text-xl font-bold text-white">🇲🇻 馬爾地夫</h3>
          ...
          <!-- 埃及 -->
          <div class="space-y-2">
            <h3 class="text-xl font-bold text-white">🇪🇬 埃及</h3>
...
# 強制推送更新
echo "🚀 正在將包含國旗 Icon 的『活動列表』推送至 GitHub..."
git add src/pages/schedule.astro
git commit -m "Restore all country flag icons in Schedule page" || true
