...
<Layout title="首頁 Index :: Fun肆潛水-Fun 4 Diving Official">
  ...
  <div class="py-16 px-4 sm:px-6 max-w-7xl mx-auto space-y-20">
    ...
    <section class="space-y-8">
      ...
      <div class="space-y-6">
        <!-- 新聞 1 -->
        <div class="bg-slate-900 rounded-2xl border border-slate-800 p-6 sm:p-8 flex flex-col md:flex-row gap-6 items-center shadow-xl group hover:border-cyan-500/40 transition duration-300">
          <a href="/news/line-community" class="w-full md:w-64 h-44 shrink-0 overflow-hidden rounded-xl">
            <img 
          ...
          <div class="space-y-4 flex-grow flex flex-col justify-between h-full">
            <div class="space-y-2">
              <h3 class="text-xl font-bold text-white hover:text-cyan-400 transition">
                <a href="/news/line-community">加入Line社群可享群友優惠並即時獲得最新行程資訊</a>
              </h3>
        ...
        <!-- 新聞 2 -->
        <div class="bg-slate-900 rounded-2xl border border-slate-800 p-6 sm:p-8 flex flex-col md:flex-row gap-6 items-center shadow-xl group hover:border-cyan-500/40 transition duration-300">
          <a href="/news/course-discount" class="w-full md:w-64 h-44 shrink-0 overflow-hidden rounded-xl">
            <img 
          ...
          <div class="space-y-4 flex-grow flex flex-col justify-between h-full">
            <div class="space-y-2">
              <h3 class="text-xl font-bold text-white hover:text-cyan-400 transition">
                <a href="/news/course-discount">OW、AOW課程團報特價</a>
              </h3>
              <p class="text-slate-300 text-sm leading-relaxed">
