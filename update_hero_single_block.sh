...
<Layout title="首頁 Index :: Fun肆潛水-Fun 4 Diving Official">
  ...
  <section class="relative min-h-[85vh] sm:min-h-[750px] flex items-center justify-center overflow-hidden py-20 px-4 sm:px-6">
    ...
    <div class="relative z-10 max-w-5xl mx-auto text-center space-y-8">
      ...
      <!-- 4. 整合為單一精緻特色區塊 (一個大框包覆所有重點) -->
      <div class="bg-slate-900/70 backdrop-blur-md p-5 sm:p-6 rounded-2xl border border-white/10 max-w-4xl mx-auto shadow-2xl">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center divide-x-0 md:divide-x divide-slate-800/80">
          <div class="space-y-1 p-2">
            <div class="text-cyan-400 font-bold text-sm sm:text-base">🤿 專業導潛及教練</div>
            <div class="text-slate-300 text-xs">嚴格把關安全品質</div>
          </div>
          <div class="space-y-1 p-2">
            <div class="text-cyan-400 font-bold text-sm sm:text-base">🌊 國內外熱門潛旅</div>
            <div class="text-slate-300 text-xs">小琉球/綠島/帛琉/西巴丹</div>
          </div>
          <div class="space-y-1 p-2">
            <div class="text-cyan-400 font-bold text-sm sm:text-base">🏠 東北角背包客房</div>
            <div class="text-slate-300 text-xs">溫馨乾淨棲息基地</div>
          </div>
          <div class="space-y-1 p-2">
            <div class="text-cyan-400 font-bold text-sm sm:text-base">🛡️ 合法立案投保</div>
            <div class="text-slate-300 text-xs">全程投保安心保障</div>
          </div>
        </div>
      </div>
