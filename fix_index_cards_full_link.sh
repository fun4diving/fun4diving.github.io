#!/bin/bash
set -e
echo "🎨 正在更新首頁：移除漸層黑與按鈕，並將整張卡片改為全區可點擊連結..."
...
<Layout title="Fun肆潛水-Fun 4 Diving Official :: 首頁 Index">
  ...
  <!-- 3. 課程及行程詳細內容區塊 (整張卡片為大連結，無按鈕、無漸層黑遮擋) -->
    ...
    <div class="max-w-6xl mx-auto space-y-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        >
          ...
          <div class="p-8 space-y-2 text-center flex-grow flex flex-col justify-center">
...
# 推送至 GitHub
echo "🚀 正在將卡片改為全區連結並推送至 GitHub..."
git add src/pages/index.astro
git commit -m "Convert course and schedule cards to full clickable links and remove button and gradient mask" || true
git push origin main --force

echo "✨ 成功修復！整張卡片現在都可以直接點擊 jump 囉！"
