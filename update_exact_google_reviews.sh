#!/bin/bash
set -e
echo "📝 正在更新：載入指定 3 則 Google 地圖真實評論，並縮小 LINE 浮動按鈕..."

# 1. 更新 Layout.astro - 縮小右下角浮動 LINE 按鈕尺寸
...
# 2. 更新 index.astro - 精確載入指定 3 則 Google 地圖評論
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-bold text-white text-sm">ling Chen</p>
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-bold text-white text-sm">不吃魚的貓</p>
                  <p class="text-xs text-cyan-400">Google 驗證評論</p>
                </div>
              </div>
              <span class="text-xs text-amber-400 font-bold">★★★★★</span>
            ...
            <p class="text-slate-200 text-sm leading-relaxed">
              「教練們人都很好。專業度十足<br />二樓有休息室<br />店外可以看陰陽海」
            </p>
          </div>
          <div class="pt-3 border-t border-slate-800/80 text-xs text-slate-400 flex items-center justify-between">
            <span>來自 Google Maps 評論</span>
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-bold text-white text-sm">WT</p>
                  <p class="text-xs text-cyan-400">Google 驗證評論</p>
                </div>
              </div>
              <span class="text-xs text-amber-400 font-bold">★★★★★</span>
            ...
            <p class="text-slate-200 text-sm leading-relaxed">
              「考完ow證照 第一支fundive就給fun 肆 報了平日 只有我自己 教練還一對一vip帶我真的好感動 🥹真的大推」
            </p>
          </div>
          <div class="pt-3 border-t border-slate-800/80 text-xs text-slate-400 flex items-center justify-between">
            <span>來自 Google Maps 評論</span>
        ...
        <div class="bg-slate-900/90 rounded-2xl border border-slate-800 p-6 sm:p-8 flex flex-col md:flex-row gap-6 items-center shadow-xl">
          ...
          <div class="space-y-4 flex-grow w-full">
            ...
            <div class="pt-2">
              <a 
                href="/courses" 
                class="inline-block px-6 py-2.5 rounded-full bg-cyan-600 hover:bg-cyan-500 text-white font-bold text-sm transition duration-300 shadow-lg shadow-cyan-500/20"
              >
                查看課程與優惠 ➔
              </a>
            </div>
...
# Git 提交並自動推送至 GitHub
git add . && git commit -m "Update exact 3 Google Maps reviews (ling Chen, 不吃魚的貓, WT) and resize floating LINE button" && git push origin main

echo "✨ 完成！3 則真實 Google Maps 評論已載入，LINE 浮動按鈕也已適度縮小，網頁已同步更新發布！"
