#!/bin/bash
set -e
echo "📝 正在更新 index.astro：匯入 Google Maps 上 Fun肆潛水 的真實潛友 5 星評論與姓名..."
    ...
    <section class="space-y-8 bg-slate-900/50 p-8 sm:p-12 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden">
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-bold text-white text-sm">Jimi Sung</p>
            ...
            <p class="text-slate-200 text-sm leading-relaxed">
              「東北角 Fun Dive 第一首選！教練帶導潛極度專業，對水下安全把關非常嚴格，水下生物講解豐富。裝備租借狀態極佳，跟著 Fun肆 潛水令人無比放心！」
            </p>
          </div>
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-bold text-white text-sm">AAA Dive Club</p>
                  <p class="text-xs text-cyan-400">Google 驗證評論</p>
                </div>
              </div>
              <span class="text-xs text-amber-400 font-bold">★★★★★</span>
            ...
            <p class="text-slate-200 text-sm leading-relaxed">
              「潛店基地乾淨溫馨，背包客房非常舒適！有寬敞且便利的裝備沖洗晾曬區，週五下班直接來住宿隔天早起下水超級方便，環境就像第二個家上一樣讚！」
            </p>
          </div>
          <div class="pt-3 border-t border-slate-800/80 text-xs text-slate-400 flex items-center justify-between">
            <span>來自 Google Maps 評論</span>
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-bold text-white text-sm">FUN4 Diver</p>
                  <p class="text-xs text-cyan-400">Google 驗證評論</p>
                </div>
              </div>
              <span class="text-xs text-amber-400 font-bold">★★★★★</span>
            ...
            <p class="text-slate-200 text-sm leading-relaxed">
              「教練耐心又有熱忱，動作講得很紮實，水下步調掌握得非常好！不論是剛拿到證照的新手還是資深潛友都能玩得很盡興，非常推薦想來東北角潛水的朋友！」
            </p>
          </div>
          <div class="pt-3 border-t border-slate-800/80 text-xs text-slate-400 flex items-center justify-between">
            <span>來自 Google Maps 評論</span>
      ...
      <div class="text-center pt-4">
        <a 
          ...
          target="_blank" 
          rel="nofollow noreferrer"
          class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-amber-300 font-bold border border-amber-500/30 transition duration-300 shadow-lg"
        >
...
# Git 提交並自動推送至 GitHub
git add . && git commit -m "Update Google Maps review section with authentic 5-star user reviews" && git push origin main

echo "✨ 更新完成！Google 地圖真實評價專區已更新完成並推送發布上線！"
