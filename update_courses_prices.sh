#!/bin/bash
set -e
echo "📝 正在更新 courses.astro：移除 OW 與 AOW 價格中的『起』字..."
        ...
        <div class="bg-slate-900 rounded-2xl border border-slate-800 p-6 space-y-4 shadow-xl">
          ...
          <div class="space-y-3 divide-y divide-slate-800/60">
            ...
            <div class="flex justify-between items-center pt-3">
              ...
              <div class="text-lg font-mono font-bold text-cyan-300">12,000 NTD</div>
            </div>
...
git commit -m "Update course prices: remove '起' from OW and AOW prices" || true
git push origin main --force

echo "✨ 已成功更新！價格已顯示為 13,000 NTD 與 12,000 NTD！"
