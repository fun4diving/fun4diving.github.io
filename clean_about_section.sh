#!/bin/bash
set -e
echo "📝 正在清理 index.astro 中『關於Fun肆』多餘的文字與大標題..."
...
<Layout title="首頁 Index :: Fun肆潛水-Fun 4 Diving Official">
  ...
  <div class="py-16 px-4 sm:px-6 max-w-7xl mx-auto space-y-20">
    ...
    <!-- 2. 精簡版：關於Fun肆 區塊 -->
    <section class="relative bg-slate-900/80 p-8 sm:p-12 rounded-3xl border border-slate-800 shadow-2xl">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div class="lg:col-span-7 space-y-6">
          ...
          <div class="pt-2">
            <a 
              href="/about" 
              class="inline-flex items-center gap-2 px-7 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-sm hover:scale-105 transition duration-300 shadow-lg shadow-cyan-500/20"
            >
              了解更多我們的故事 →
            </a>
          </div>
        ...
        <div class="lg:col-span-5">
          <div class="rounded-2xl overflow-hidden border border-slate-700/50 shadow-2xl aspect-[4/3]">
            <img 
...
# Git 提交並自動推送至 GitHub
git add . && git commit -m "Remove unnecessary subtitle and text from About section" && git push origin main

echo "✨ 完成！多餘文字已移除，程式碼已自動發布！"
